...
$sqlcmd="SELECT device FROM device where device <>'N/A'";
...
require($path.'login/dblink.php');
$sqlcmd="SELECT processor FROM processor";
$result=mysqli_query($myconn,$sqlcmd);
...
<td><input type="submit" value="Links" id="docs" onclick="populate_links()"/></td>
</tr>
</table>
</div>

<div class="dcs" id="dcs">
</div>
